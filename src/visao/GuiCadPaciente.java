...
public class GuiCadPaciente extends javax.swing.JInternalFrame {
    ...
    private boolean verificarCamposObrigatorios(){
        ...
        if (jtEndereco.getText().isEmpty()) {
            mensagensErro.add("Informe o endereço do paciente.");
        }
        ...
        if (jtDataNasc.getText().isEmpty()) {
            mensagensErro.add("Informe a data de nascimento do paciente");
        }

        if (jcConvenio.getSelectedIndex() == 0) {
            mensagensErro.add("Informe o convênio do paciente.");
        }
