    ...
    private void buscarFiltro() {
        try {
         ...
         devolve um Object selecionado na JCombo */
                ...
                // Criando ArrayList para popular com filtros
                List<Paciente> p = new ArrayList<>();

                String query = jtFiltro.getText();
                ...
                if (pesquisa.equals("Código Paciente")) {
                    p = ps.buscarPacienteId(query);
                } else if (pesquisa.equals("CPF")) {
                    p = ps.buscarPacienteCpf(query);
                } else {
                    p = ps.buscarPacienteNome(query);
                }
